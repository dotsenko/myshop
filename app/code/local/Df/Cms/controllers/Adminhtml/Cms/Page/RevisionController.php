...
class Df_Cms_Adminhtml_Cms_Page_RevisionController extends Df_Cms_Adminhtml_Cms_PageController
{
    ...
    public function deleteAction()
    {
        ...
        if ($id = $this->getRequest()->getParam('revision_id')) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(df_helper()->cms()->__('Revision was successfully deleted.'));
                ...
                Mage::logException($e);
                Mage::getSingleton('adminhtml/session')->addError(df_helper()->cms()->__('Error while deleting revision. Please try again later.'));
                $error = true;
            }
        ...
        // display error message
        Mage::getSingleton('adminhtml/session')->addError(df_helper()->cms()->__('Unable to find a revision to delete.'));
        // go to grid
    ...
    public function editAction()
    {
        ...
        if ($revisionId && !$revision->getId()) {
            Mage::getSingleton('adminhtml/session')->addError(
                df_helper()->cms()->__('Could not load specified revision.'));
        ...
        $this->_initAction()
            ->_addBreadcrumb(df_helper()->cms()->__('Edit Revision'),
                df_helper()->cms()->__('Edit Revision'));
    ...
    public function publishAction()
    {
        ...
        try {
            $revision->publish();
            // display success message
            Mage::getSingleton('adminhtml/session')->addSuccess(df_helper()->cms()->__('Revision was successfully published.'));
    ...
    public function saveAction()
    {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                // display success message
                Mage::getSingleton('adminhtml/session')->addSuccess(df_helper()->cms()->__('Revision was successfully saved.'));
    ...
    protected function _isAllowed()
    {
        ...
        if (
			...
			switch ($this->getRequest()->getActionName()) {
				case 'save':
					$result = Mage::getSingleton('df_cms/config')->canCurrentUserSaveRevision();
					break;
				case 'publish':
					$result = Mage::getSingleton('df_cms/config')->canCurrentUserPublishRevision();
					break;
				case 'delete':
