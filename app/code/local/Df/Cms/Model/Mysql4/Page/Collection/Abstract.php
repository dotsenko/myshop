...
abstract class Df_Cms_Model_Mysql4_Page_Collection_Abstract extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     ...
     *
     * @param mixed $page
     * @return Df_Cms_Model_Mysql4_Collection_Abstract
     */
     ...
     *
     * @return Df_Cms_Model_Mysql4_Page_Collection_Abstract
     */
        ...
        if (!$this->_usersHash) {
            ...
            foreach ($this->_toOptionHash('user_id', 'username') as $userId => $username) {
                if ($userId) {
                    ...
                    $this->_usersHash['-1'] = df_helper()->cms()->__('[No Owner]');
                }
            }
