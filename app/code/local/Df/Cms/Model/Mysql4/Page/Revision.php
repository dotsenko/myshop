...
class Df_Cms_Model_Mysql4_Page_Revision extends Mage_Core_Model_Mysql4_Abstract
{
    /**
    ...
    {
        $this->_init('df_cms/page_revision', 'revision_id');
        $this->_pageTable = $this->getTable('cms/page');
        $this->_versionTable = $this->getTable('df_cms/page_version');
     ...
     * @return Df_Cms_Model_Mysql4_Page_Revision
     */
    ...
    {
        $versionTable = $this->getTable('df_cms/page_version');
