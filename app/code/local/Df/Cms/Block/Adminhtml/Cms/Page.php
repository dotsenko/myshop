 ...
 *
 */
class Df_Cms_Block_Adminhtml_Cms_Page extends Mage_Adminhtml_Block_Template
{
    /**
			...
			if ($page) {
				...
				if($pageGrid) {
					$pageGrid->addColumnAfter('versioned', array(
						...
						'header'    => df_helper()->cms()->__('Version Control?'),
						'width'     => 10,
						'type'      => 'options',
						'options'   => array(df_helper()->cms()->__('No'),
							df_helper()->cms()->__('Yes')
						)
					), 'page_actions');
				}
			}
