...
class Df_PromoGift_Model_Indexer extends Mage_Index_Model_Indexer_Abstract {
		...
		array (
			...
			Mage_Catalog_Model_Product::ENTITY =>
				array (
					 ...
					 *
					 *
					 * Обратите внимание, что событие удаления товаров (Mage_Index_Model_Event::TYPE_DELETE)
			...
			Mage_Core_Model_Website::ENTITY =>
				array (
					 ...
					 *
					 * Обратите внимание, что событие удаления сайтов (Mage_Index_Model_Event::TYPE_DELETE)
			 ...
			 * и если её значение равно true,
			 * то ничего не делают до наступления Mage_Catalog_Model_Convert_Adapter_Product::finish()
    ...
    public function getName() {
		return df_helper()->promoGift()->__ (Df_PromoGift_Const::T_PROMO_GIFTS);
	}
    ...
    public function getDescription() {
		return df_helper()->promoGift()->__ (Df_PromoGift_Const::T_INDEXER_DESCRIPTION);
	}
    ...
    protected function _processEvent (Mage_Index_Model_Event $event) {
		...
		try {
			...
			if (
				...
				$entity = $event [Df_Index_Const::EVENT_PARAM_DATA_OBJECT];
				/** @var mixed $entity */
				...
				if (Mage_Core_Model_Website::ENTITY == $entityType) {
					...
					if (Mage_Index_Model_Event::TYPE_SAVE == $eventType) {
						...
						df_assert ($entity instanceof Mage_Catalog_Model_Product);
						...
						$collection = Mage::getResourceModel (Df_Catalog_Const::PRODUCT_COLLECTION_CLASS_MF);
						...
						if (!is_null ($entity)) {
							 ...
							 */
							$productIds = $entity [Df_Catalog_Const::PRODUCT_ACTION_PARAM__PRODUCT_IDS];
							/** @var array $productIds */
							df_assert (is_array ($productIds));

							$collection->addAttributeToFilter ('entity_id', array (Df_Varien_Const::IN => $productIds));
    ...
    public function getResource() {
		...
		/** @var Df_PromoGift_Model_Mysql4_Indexer $result */
        $result = parent::getResource();

		df_assert ($result instanceof Df_PromoGift_Model_Mysql4_Indexer);
	...
	const RESOURCE_MODEL = 'df_promo_gift/indexer';
