...
class Df_PromoGift_Const {
	...
	/**
	 * Комментарий для поля «Max Usages per Cart»
	 * в административной части на экране редактирования ценового правила
	 */
	const T_MAX_USAGES_PER_QUOTE = 'Max Usages per Cart<br/>(for promo gifting rules only)';
