...
class Df_Reward_Model_Action_InvitationCustomer extends Df_Reward_Model_Action_Abstract
{
    ...
    {
        return (int)df_helper()->reward()->getPointsConfig('invitation_customer', $websiteId);
    }
    ...
    {
        return df_helper()->reward()->getPointsConfig('invitation_customer_limit', $this->getReward()->getWebsiteId());
    }
    ...
    public function getHistoryMessage($args = array())
    {
        ...
        return df_helper()->reward()->__('Invitation to %s converted into a customer.', $email);
    }
