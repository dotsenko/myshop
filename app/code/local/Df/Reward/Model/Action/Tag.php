...
class Df_Reward_Model_Action_Tag extends Df_Reward_Model_Action_Abstract
{
    ...
    {
        return (int)df_helper()->reward()->getPointsConfig('tag', $websiteId);
    }
    ...
    {
        return df_helper()->reward()->getPointsConfig('tag_limit', $this->getReward()->getWebsiteId());
    }
    ...
    public function getHistoryMessage($args = array())
    {
        ...
        return df_helper()->reward()->__('For submitting tag (%s).', $tag);
    }
