...
class Df_Reward_Model_Action_InvitationOrder extends Df_Reward_Model_Action_Abstract
{
    ...
    {
        return (int)df_helper()->reward()->getPointsConfig('invitation_order', $websiteId);
    }
    ...
    {
        return df_helper()->reward()->getPointsConfig('invitation_order_limit', $this->getReward()->getWebsiteId());
    }
    ...
    public function getHistoryMessage($args = array())
    {
        ...
        return df_helper()->reward()->__('Invitation to %s converted into an order.', $email);
    }
