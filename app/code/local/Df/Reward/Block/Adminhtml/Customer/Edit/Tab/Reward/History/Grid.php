    ...
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        /* @var $collection Df_Reward_Model_Mysql4_Reward_History_Collection */
        $collection = Mage::getModel('df_reward/reward_history')->getCollection()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('currency_amount', array(
            ...
            'header'   => df_helper()->reward()->__('Amount Balance'),
            'sortable' => false,
            'filter'   => false,
            'width'    => 1,
        ));
        ...
        $this->addColumn('points_delta', array(
            'type'     => 'number',
            'index'    => 'points_delta',
            'header'   => df_helper()->reward()->__('Points Change'),
            'sortable' => false,
            'filter'   => false,
        ...
        $this->addColumn('currency_delta', array(
            ...
            'header'   => df_helper()->reward()->__('Amount'),
            'sortable' => false,
            'filter'   => false,
            'show_number_sign' => true,
            'width'    => 1,
...
// TODO: custom renderer for reason, which includes comments
        $this->addColumn('message', array(
            'index'    => 'message',
            'getter'   => 'getMessage',
            'header'   => df_helper()->reward()->__('Reason'),
            'sortable' => false,
            'filter'   => false,
            'align'    => 'left',
        ));
        ...
        $this->addColumn('created_at', array(
            'type'     => 'datetime',
            'index'    => 'created_at',
            'header'   => df_helper()->reward()->__('Created At'),
            'sortable' => false,
            'align'    => 'left',
        ...
        $this->addColumn('expiration_date', array(
            'type'     => 'datetime',
            'getter'   => 'getExpiresAt',
            'header'   => df_helper()->reward()->__('Expires At'),
            'sortable' => false,
...
// TODO: merge with reason
        $this->addColumn('comment', array(
            'index'    => 'comment',
            'header'   => df_helper()->reward()->__('Comment'),
            'sortable' => false,
            'filter'   => false,
            'align'    => 'left',
        ));
