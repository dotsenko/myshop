...
class Df_Sales_Const {
	...
	const ORDER_PARAM__CUSTOMER_NOTE = 'customer_note';
	const ORDER_PARAM__CUSTOMER_NOTE_NOTIFY = 'customer_note_notify';
	const ORDER_PARAM__DF_COMMENT_IS_VISIBLE_ON_FRONT = 'df_comment_is_visible_on_front';


	const ORDER_PARAM__CREATED_AT = 'created_at';
	...
	const ORDER_CLASS = 'Mage_Sales_Model_Order';
	const ORDER_CLASS_MF = 'sales/order';
