...
class Df_WalletOne_Model_Payment extends Df_Payment_Model_Method_WithRedirect {
	 ...
	 * @return Df_WalletOne_Model_Config_Facade
	 */
	public function getRmConfig ($storeId = null) {

		/** @var Df_WalletOne_Model_Config_Facade $result  */
		$result = parent::getRmConfig ($storeId);

		df_assert ($result instanceof Df_WalletOne_Model_Config_Facade);
	...
	protected function getConfigClassServiceMf () {
		...
		/** @var string $result  */
		$result = Df_WalletOne_Model_Config_Service::getNameInMagentoFormat();
	...
	protected function getRequestPaymentClassMf () {
		...
		/** @var string $result  */
		$result = Df_WalletOne_Model_Request_Payment::getNameInMagentoFormat();
	...
	protected function getRmConfigClassMf () {
		...
		/** @var string $result  */
		$result = Df_WalletOne_Model_Config_Facade::getNameInMagentoFormat();
	...
	protected function getRmFeatureCode () {
		...
		/** @var string $result  */
		$result = Df_Core_Feature::WALLET_ONE;
	...
	const RM__ID = 'wallet-one';

	const RM__FORM_BLOCK_TYPE = 'df_wallet_one/form';
	const RM__INFO_BLOCK_TYPE = 'df_wallet_one/info';
