 ...
 */
class Df_Invitation_Block_Adminhtml_Invitation_View_Tab_General extends Mage_Adminhtml_Block_Template
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return df_helper()->invitation()->__('General');
    }
    ...
    public function getCustomerGroupCode($groupId, $configUsed = false)
    {
        ...
        if ($group) {
            ...
            if ($configUsed) {
                return df_helper()->invitation()->__('Default from System Configuration');
            } else {
                return df_helper()->invitation()->__('N/A');
            }
        }
    }
    ...
    public function getInvitationUrl()
    {
        ...
        return df_helper()->invitation()->getInvitationUrl($this->getInvitation());
    }
