...
class Df_Invitation_Block_Adminhtml_Invitation_Add extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        $validationMessage = addcslashes(df_helper()->invitation()->__('Please enter valid email addresses, separated by new line.'), "\\'\n\r");
    ...
    {
        return df_helper()->invitation()->__('New Invitations');
    }
