 ...
 */
class Df_Invitation_Model_Mysql4_Report_Invitation_Customer_Collection
    extends Mage_Reports_Model_Mysql4_Customer_Collection
{
     ...
     * @return Df_Invitation_Model_Mysql4_Report_Invitation_Customer_Collection
     */
    public function setDateRange($from, $to)
    {
        $this->_reset();
        $this->getSelect()
            ->join(array('invitation'=>$this->getTable('df_invitation/invitation')),
