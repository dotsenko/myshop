 ...
 */
class Df_Invitation_Model_Mysql4_Report_Invitation_Collection
    extends Df_Invitation_Model_Mysql4_Invitation_Collection
{
     ...
     * @return Df_Invitation_Model_Mysql4_Report_Invitation_Collection
     */
