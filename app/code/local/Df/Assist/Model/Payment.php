...
class Df_Assist_Model_Payment extends Df_Payment_Model_Method_WithRedirect {
	 ...
	 * @return Df_Assist_Model_Config_Facade
	 */
	public function getRmConfig ($storeId = null) {

		/** @var Df_Assist_Model_Config_Facade $result  */
		$result = parent::getRmConfig ($storeId);

		df_assert ($result instanceof Df_Assist_Model_Config_Facade);
	...
	protected function getConfigClassServiceMf () {
		...
		/** @var string $result  */
		$result = Df_Assist_Model_Config_Service::getNameInMagentoFormat();
	...
	protected function getRequestPaymentClassMf () {
		...
		/** @var string $result  */
		$result = Df_Assist_Model_Request_Payment::getNameInMagentoFormat();
	...
	protected function getRmConfigClassMf () {
		...
		/** @var string $result  */
		$result = Df_Assist_Model_Config_Facade::getNameInMagentoFormat();
	...
	const RM__FORM_BLOCK_TYPE = 'df_assist/form';
	const RM__INFO_BLOCK_TYPE = 'df_assist/info';
