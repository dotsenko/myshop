		...
		return
			array (
				array (
					...
					,
					'label' => df_helper ()->catalog ()->__ ('Над статичным блоком')
				)
				,
				array (
					'value' => self::DF_BEFORE_PRODUCTS
					,
					'label' => df_helper ()->catalog ()->__ ('Под статичным блоком, но над товарами')
				)
				,
				array (
					'value' => self::DF_AFTER_PRODUCTS
					,
					'label' => df_helper ()->catalog ()->__ ('Под товарами')
				)
				,
				array (
					'value' => self::DF_BEFORE_AND_AFTER_PRODUCTS
					,
					'label' => df_helper ()->catalog ()->__ ('Над товарами и под товарами')
				)
			)
		;
	}
