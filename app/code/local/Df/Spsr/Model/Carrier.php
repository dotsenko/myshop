...
class Df_Spsr_Model_Carrier extends Df_Shipping_Model_Carrier {
	...
	protected function getCollectorClassMf () {
		return Df_Spsr_Model_Rate_Collector::getNameInMagentoFormat();
	}
	...
	protected function getConfigClassServiceMf () {
		return Df_Spsr_Model_Config_Area_Service::getNameInMagentoFormat();
	}
	...
	protected function getRmConfigClassMf () {
		return Df_Spsr_Model_Config_Facade::getNameInMagentoFormat();
	}
