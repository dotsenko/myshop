...
class Df_RbkMoney_Model_Payment extends Df_Payment_Model_Method_WithRedirect {
	 ...
	 * @return Df_RbkMoney_Model_Config_Facade
	 */
	public function getRmConfig ($storeId = null) {

		/** @var Df_RbkMoney_Model_Config_Facade $result  */
		$result = parent::getRmConfig ($storeId);

		df_assert ($result instanceof Df_RbkMoney_Model_Config_Facade);
	...
	protected function getConfigClassServiceMf () {
		...
		/** @var string $result  */
		$result = Df_RbkMoney_Model_Config_Service::getNameInMagentoFormat();
	...
	protected function getRequestPaymentClassMf () {
		...
		/** @var string $result  */
		$result = Df_RbkMoney_Model_Request_Payment::getNameInMagentoFormat();
	...
	protected function getRmConfigClassMf () {
		...
		/** @var string $result  */
		$result = Df_RbkMoney_Model_Config_Facade::getNameInMagentoFormat();
	...
	protected function getRmFeatureCode () {
		...
		/** @var string $result  */
		$result = Df_Core_Feature::RBK_MONEY;
	...
	const RM__ID = 'rbk-money';

	const RM__FORM_BLOCK_TYPE = 'df_rbk_money/form';
	const RM__INFO_BLOCK_TYPE = 'df_rbk_money/info';
